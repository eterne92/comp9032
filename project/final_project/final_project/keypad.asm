...
KEY_VALUE:
	...
	KEY_VALUE_LOOP:
		RCALL KEY_ASCII				;GET A VALUE
		LCD_WRITE_DATA_reg R23		;DISPLAY EVERY KEY PRESSED
		CPI R23, '#'
		BREQ KEY_VALUE_RETURN
		SUBI R23, '0'				;GET THE REAL VALUE
		CPI R23, 0
		BRLO KEY_VALUE_OVERFLOW
		CPI R23, 10
		BRSH KEY_VALUE_OVERFLOW		;MAKE SURE key value is between 0-9, if not -> overflow
		;convert r17
		LDI R18, 10					
		MUL R17, R18
		LDI R18, 0
		CP R18, R1
		BRNE KEY_VALUE_OVERFLOW		;IF R17 * 10 > 255 -> overflow
		MOV R17, R0					;R17 = R17 * 10
		ADD R17, R23
